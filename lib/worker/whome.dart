       ...
       children: [
         ...
         Padding(
           ...
           child: Row(mainAxisSize: MainAxisSize.min,
             children: [
               Activity(icn: Icon(Icons.person), txt: 'Profile', clr: Colors.green, tap: (){}),
               SizedBox(width: 20,),
               Activity(icn: Icon(Icons.view_kanban_outlined), txt: 'Requests', clr: Colors.red, tap: (){}),
               SizedBox(width: 20,),
               Activity(icn:Icon (Icons.feedback), txt: 'Feedbacks', clr: Colors.green, tap: (){}),
               SizedBox(width: 20,),
               Activity(icn: Icon(Icons.view_agenda_rounded), txt: 'Post Work', clr: Colors.yellowAccent, tap: (){})
             ],
           ),
         ),
         Padding(
