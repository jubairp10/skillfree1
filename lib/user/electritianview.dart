...
import 'package:skillfree/user/electritians.dart';
...
// void main(){
//   runApp(MaterialApp(home:paintersview(),
//   )
//   );
// }
class electritianview extends StatefulWidget{
  @override
  State<electritianview> createState() => _paintersviewState();
}

class _paintersviewState extends State<electritianview> {
  var id=[001];
  var name= ['John Smith'];
  var daily_wage= [800];
          ...
          itemBuilder: (BuildContext context, int index) {
            return  Card(color: Colors.lightBlue[100],
              child: ListTile(onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>electritian()));
              },
